...
// jurisdiction + issuer. Writes build/input_Z.json for snarkjs and prints publics.
...
async function main() {
  ...
  const identitySecret = 97531864209753186420n;
  const salt = 86420975318642097531n;
  ...
  fs.writeFileSync("build/input_Z.json", JSON.stringify(input, null, 1));
  ...
  console.log("Z nullifier  =", nul);
  console.log("Z commitment =", com);
}
