...
def main():
    ...
    v = {"package": "hash-2bc9a8556c75ee912bab4f7d2cf2622863d1f1e29eb5cf68685a52d6a718ff61", "contract": "hash-c99e443ff8cdc6164c863d5f11d88aa309bc105a69d2037bfb7cbfe9dbbb076b"}
    man["verifier"]=v; save(man)
    r = step(man, "registry", f"{C}/credential-registry/wasm/CredentialRegistry.wasm", 500000000000,
             odra_cfg("writ_registry_v4") + [
    ...
    cep = step(man, "cep78", f"{C}/writ-cep78/wasm/cep78.wasm", 650000000000, [
        {"name": "collection_name", "type": "String", "value": "writ-rwa-bond-v4"},
    ...
    tok = step(man, "token", f"{C}/writ-token/wasm/WritToken.wasm", 250000000000,
               odra_cfg("writ_token_v4") + [{"name": "filter", "type": "Key", "value": ftok["package"]}])
