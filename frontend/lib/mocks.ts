...
export const HOLDERS: Holder[] = [
  ...
  { nullifier: "0x5d12…7b08", status: "PENDING", jurisdiction: "SG-Accredited", credentialExpiry: "n/a", lastReScreen: "n/a" },
...
export const PROVING_STEPS = [
  ...
  { key: "claims", title: "Load claims", body: "Pull your accreditation & jurisdiction claims from your KYC issuer, all locally on your device." },
